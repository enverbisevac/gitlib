...
// CatFileBatchCheckReader opens git cat-file --batch-check in the provided repo and returns a stdin pipe, a stdout reader and cancel function
func CatFileBatchCheckReader(ctx context.Context, repoPath string) (WriteCloserError, *bufio.Reader, func()) {
...
// CatFileBatchReader opens git cat-file --batch in the provided repo and returns a stdin pipe, a stdout reader and cancel function
func CatFileBatchReader(ctx context.Context, repoPath string) (WriteCloserError, *bufio.Reader, func()) {
...
func ParseTreeLine(rd *bufio.Reader, modeBuf, fnameBuf, shaBuf []byte) (mode, fname, sha []byte, n int, err error) {
	...
	if idx < 0 {
		log.Info("missing space in readBytes ParseTreeLine: %s", readBytes)
